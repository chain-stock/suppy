...
class Node:
    ...
    def assemblies_feasible(self, stock: IdDict[Node, float] = None) -> int:
    ...
    def satisfy_received_receipts(self):
    ...
    def satisfy_sales(self, period: int):
...
class Orders(IdDict[Node, float]):
...
class Stock(IdDict[Node, float]):
    ...
    def add_received(self, received: list[Receipt]):
